...
class RigidSolver(KinematicSolver):
    ...
    def substep_pre_coupling_grad(self, f):
        ...
        # (legacy no-op behavior). This avoids the NaN gradients that can originate from the forward-kinematics
        # quaternion backward at near-degenerate configurations. The coupling/deformable backward is unaffected.
